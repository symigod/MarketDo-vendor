...
import 'package:marketdo_app_vendor/screens/order%20screen/order_details.dart';
                      ...
                      child: Column(
                        children: [
                          ...
                          ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var productImage = products[index]['imageUrls']
                                    .toString()
                                    .replaceAll('[', '')
                                    .replaceAll(']', '');
                                var productName = products[index]['name'];
                                var productPrice =
                                    products[index]['regularPrice'].toString();
                                return Padding(
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: orderStatus == 'Accepted'
                                      ? Colors.green
                                      : Colors.grey,
                              ...
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: orderStatus == 'Preparing'
                                      ? Colors.green
                                      : Colors.grey,
                                  minimumSize: const Size(150, 40),
                                ),
                          ...
                          Row(
                            ...
                            children: [
                              ElevatedButton(
                                ...
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: orderStatus == 'On Delivery'
                                      ? Colors.green
                                      : Colors.grey,
                                  minimumSize: const Size(150, 40),
                                ),
