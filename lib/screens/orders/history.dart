...
class _OrderHistoryScreenState extends State<OrderHistoryScreen> {
                                            ...
                                            child: Container(
                                                decoration: BoxDecoration(
                                                    ...
                                                    border: Border.all(
                                                        ...
                                                        width: 2)),
                                                child:
                                                    ClipRRect(borderRadius: BorderRadius.circular(50), child: CachedNetworkImage(imageUrl: customer['logo'], fit: BoxFit.cover)))),
                        ...
                        content: Column(children: [
                          ...
                          StreamBuilder(
                              stream: Stream.fromFuture(Future.wait(
                                  products.map((productId) => productsCollection
                                      .doc(productId)
                                      .get()))),
                              builder: (context, ps) {
  ...
  updateOrderStatus(String orderID, bool isDelivered) => ordersCollection
      .doc(orderID)
      .update({'isDelivered': isDelivered}).catchError(
